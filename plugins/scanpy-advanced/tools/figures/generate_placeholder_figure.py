"""Generate a deterministic placeholder figure for scanpy-advanced.

This produces a single 1×1 PNG that is then read + re-saved via Pillow
...
OUT_PATH = Path(__file__).parent / "umap_placeholder.png"
